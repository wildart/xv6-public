...
/* ============================================================================= *
 * Do not modify anything in this file without the explicit permission.          *
 * ============================================================================= */
...
//
// Processes will live for L4T_SECONDS.
//
...
//
// Every seventh process will sleep for L4T_CHILD_SLEEP_SECONDS (whatever that
...
main(int argc, char* argv[])
{
  ...
  while (pc < L4T_MAX) {
    ...
    printf(1, "Created %d processes. Sleeping for %d seconds.\n",
           pc % L4T_TO_CREATE ? pc % L4T_TO_CREATE : L4T_TO_CREATE,
           L4T_PARENT_SLEEP_SECONDS);
    sleep(L4T_PARENT_SLEEP_SECONDS * TPS);
  }
